...
Mobile.setText(findTestObject('Item/Number of Order/Input - Number Of Order'), '1', 0)

Mobile.tap(findTestObject('Item/Number of Order/Button - Add'), 0)

Mobile.tap(findTestObject('Item/Button - Cart'), 0)

Mobile.verifyElementVisible(findTestObject('Cart/With Item/Text - Item 1 Name'), 0)
