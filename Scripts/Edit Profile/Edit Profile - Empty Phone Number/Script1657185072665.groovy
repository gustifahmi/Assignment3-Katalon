...
Mobile.setText(findTestObject('Edit Profile/Input Phone Number/Input - Phone number'), '', 0)

Mobile.tap(findTestObject('Edit Profile/Input Phone Number/Button - OK'), 0)

Mobile.verifyElementVisible(findTestObject('Edit Profile/Alert - Invalid Phone Input'), 0)
