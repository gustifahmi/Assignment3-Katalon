...
Mobile.setText(findTestObject('Edit Profile/Input Address/Input - Address'), '', 0)

Mobile.tap(findTestObject('Edit Profile/Input Address/Button - OK'), 0)

Mobile.verifyElementVisible(findTestObject('Edit Profile/Alert - Invalid Address Input'), 0)
